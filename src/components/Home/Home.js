import logoName from "../../assets/images/DDname.png";
...
fetch("https://api.counterapi.dev/v1/dhiraj-portfolio/visits/up")
      ...
      <div className="home-page">
        ...
        <div className="container ">
          <div className="text-zone">
            ...
            <h2>
              Full Stack Developer |  Web Designer | Open to Opportunities
            </h2>
